...
public class Login extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(passPass, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        SQLtoJava.user = txtUser.getText();
        SQLtoJava.pass = passPass.getText();
        db.setCredentials(SQLtoJava.user, SQLtoJava.pass);
        System.out.println("\"" + txtUser.getText() + "\", \"" + passPass.getText() + "\"");
        db.conectar();
        db.desconectar();
